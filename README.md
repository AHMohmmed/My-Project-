...
```bash
git clone https://github.com/AHMohmmed/Python-Weather-Info-App.git
```
...
- **Follow me on GitHub**: [AHMohmmed](https://github.com/AHMohmmed)
...
- GitHub: [AHMohmmed](https://github.com/AHMohmmed)
- Email: <ab.hadimohammed@gmail.com>
